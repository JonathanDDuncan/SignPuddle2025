JonathanDDuncan: Compare #file:CODEBASE_ANALYSIS_Context.md  and #file:SignPuddle-Analysis_Context.md 
...
2. **Performance Bottlenecks**: Details specific performance issues:
